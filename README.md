# @cursecode/funcaptcha
A library used to interact with funcaptchas.
## Installation
This package is available on npm.  
Simply run: `npm install @cursecode/funcaptcha`
## Usage And Documentation
Require the library like any other
```js
import fun from "funcaptcha"
```
...
## Support the original author (noahcoolboy)
```
...
* Ko-Fi (PayPal): (https://ko-fi.com/noahcoolboy)
```
